...
module.exports = {
  ...
  ERROR_CODES: {
    ...
    INVALID_CURATED_LIBRARY_SNAPSHOT: 'INVALID_CURATED_LIBRARY_SNAPSHOT',
    CURATED_LIBRARY_REVISION_CONFLICT: 'CURATED_LIBRARY_REVISION_CONFLICT',
    CURATED_LIBRARY_FIRST_SNAPSHOT_EXISTS: 'CURATED_LIBRARY_FIRST_SNAPSHOT_EXISTS',
    CURATED_LIBRARY_FIRST_SNAPSHOT_LOCKED: 'CURATED_LIBRARY_FIRST_SNAPSHOT_LOCKED',
    CURATED_LIBRARY_BLOB_NOT_FOUND: 'CURATED_LIBRARY_BLOB_NOT_FOUND',
    CURATED_LIBRARY_BLOB_HASH_MISMATCH: 'CURATED_LIBRARY_BLOB_HASH_MISMATCH',
    CURATED_LIBRARY_BLOB_OFFSET_MISMATCH: 'CURATED_LIBRARY_BLOB_OFFSET_MISMATCH',
    CURATED_LIBRARY_QUOTA_EXCEEDED: 'CURATED_LIBRARY_QUOTA_EXCEEDED',
    CURATED_LIBRARY_DISK_FULL: 'CURATED_LIBRARY_DISK_FULL',
    CURATED_LIBRARY_PROTOCOL_UNSUPPORTED: 'CURATED_LIBRARY_PROTOCOL_UNSUPPORTED',
  ...
  COLLECTIONS: {
    ...
    USER_CURATED_LIBRARY_SNAPSHOTS: 'user_curated_library_snapshots',
    USER_CURATED_LIBRARY_BLOBS: 'user_curated_library_blobs',
  ...
  LIMITS: {
    ...
    DEFAULT_MAX_CURATED_BLOB_BYTES_PER_USER: parseInt(
      process.env.DEFAULT_MAX_CURATED_BLOB_BYTES_PER_USER || String(100 * 1024 * 1024 * 1024)
    )
  },
  ...
  CURATED_LIBRARY_SYNC: {
    ...
    FIRST_SNAPSHOT_LOCK_MS: parseInt(process.env.CURATED_LIBRARY_FIRST_SNAPSHOT_LOCK_MS || String(2 * 60 * 60 * 1000)),
    CHUNK_SIZE_BYTES: parseInt(process.env.CURATED_LIBRARY_BLOB_CHUNK_SIZE || String(8 * 1024 * 1024))
  }
};
